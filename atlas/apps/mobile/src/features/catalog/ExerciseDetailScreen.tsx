...
export function ExerciseDetailScreen() {
  ...
  return (
    <Screen>
      {/* ScrollView e não FlashList: o conteúdo é um hero, três cards e ~6
          linhas de instrução. Virtualizar isso só custava um `ListHeaderComponent`
          gigante — e era ele que empurrava os pontos de execução para o rodapé,
          repetindo o rótulo da seção em cada linha. */}
